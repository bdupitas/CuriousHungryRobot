...
interface CuriousHungryRobot { //holds all constants for now
    ...
    final int numberOfEnergyHubs = 100; //Also # of objects //UPDATE#2
    ...
    final double energyIntervals = 20; // holds the minimum interval between the energy hub
    final int TRIAL_LIMIT = 5;
}